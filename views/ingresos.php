...
<uib-tabset active="active" class="col-md-12 tab-normal">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row" ng-class="{'has-error':Form_insertarIngresos.cantidad.$invalid && Form_insertarIngresos.cantidad.$dirty}">
                                <label class="col-md-3 col-form-label" ng-if="insertIngresos.fraccion!=0">Cantidad Caja</label>
                                <label class="col-md-3 col-form-label" ng-if="insertIngresos.fraccion==0">Cantidad Unidad</label>
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <tr ng-repeat="listado in filterDatProducIngreso = (listadodeProductos_Ingreso | filter : filtroProductoIngreso) | limitTo:20:20*(pagelistadodeProductos_Ingreso-1)">
                                                    <td> <strong> {{listado.codigo_producto}}</strong></td>
                                                    <td>{{listado.descripcion}} {{listado.presentacion}}</td>
                                                    <td><strong>$ {{listado.valor_venta | number:0}}</strong></td>
                                                    <td><strong ng-if="listado.fraccion!=0">$ {{listado.valor_unidad | number:0}}</strong></td>
                                                    <td ng-show="false">{{listado.codigo_barras}}</td>
                                                    <td>
                                                        <button type="button" class="btn btn-info btn-sm" data-dismiss="modal" ng-click="agregarProductoIngresosInsert(listado.id_producto,listado.descripcion,listado.codigo_producto,listado.fraccion,insertIngresos)">+</button>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
            ...
            <div class="col-md-8">
                <div class="row">
                    <div class="col-md-12">
                        <div class="container-3">
                            <span class="icon"><i class="material-icons">search</i></span>
                            <input type="search" placeholder="Busqueda general..." id="search" onclick="ClearSearch()" onfocus="ClearSearch()" name="id_producto" ng-model="filtroAddFactura" autofocus="autofocus">
                        </div>
                    </div>
                    <div class="col-md-12 paginacion">
                        <uib-pagination class="pagination-mod" total-items="filterADDF.length" ng-model="pagelistadodetodos_addFactura" max-size="5" class="pagination-sm" boundary-links="true" ng-change="paginalistadodetodos_addFactura()" previous-text="&lsaquo;" next-text="&rsaquo;" items-per-page=4></uib-pagination>
                    </div>
                    <div class="col-md-3 js-contenedor" ng-repeat="listadoADDF in filterADDF = (listadodetodos_addFactura | filter: filtroAddFactura )  | limitTo:4:10*(pagelistadodetodos_addFactura-4)">
                        <div class="card">
                            <div class="panel panel-body facturaOption">
                                <div class="card-header card-header-rose card-header-icon">
                                    <div class="card-icon" data-toggle="modal" data-target="#myModalFacturaSelect" ng-click="cambioNombreFactura(listadoADDF.nombre_factura,listadoADDF.id_ingresofactura)">
                                        <i class="material-icons">calendar_today</i>
                                    </div>
                                    <h4 class="card-title">Factura</h4>
                                </div>
                                <div class="card-body" ng-click="SelectFacturaAdd(listadoADDF.nombre_factura,listadoADDF.id_ingresofactura,listadoADDF.estado,AddFacturaSelect)">
                                    <div class="col-md-12">
                                        <h4 class="tfactura"><strong>{{listadoADDF.nombre_factura}}</strong></h4>
                                    </div>
                                </div>
                                <div class="card-footer">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="panel panel-body fact">
                                <h4>Factura Seleccionada</h4>
                                <h2><strong> {{AddFacturaSelect.nombre_facturaSelect}}</strong></h2>
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="panel panel-body fact">
                                <h4> C. Productos </h4>
                                <h2>{{listadodetodos_SelectFacturaAdd.length}}</h2>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3" ng-if="AddFacturaSelect.estado!=0">
                            <div ng-if="claveInvetario==0">
                                ...
                                <button type="button" class="btn btn-info btn-sm" data-dismiss="modal"><i class="material-icons">check_circle</i> Confirmar</button>
                            </div>
                        </div>
                    </div>
                    <!--            <div class="col-md-2">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="col-md-12">
                        <div class="container-3">
                            <span class="icon"><i class="material-icons">search</i></span>
                            <input type="search" placeholder="Busqueda general..." id="search" onclick="ClearSearch()" onfocus="ClearSearch()" name="id_producto" ng-model="filtroProductoIngreso" ng-change="listadotodos_ProductoChangeAdd(filtroProductoIngreso,AddFacturaSelect)" ng-focus="noBarraNew()" ng-keypress="listadotodos_ProductoKeypressAdd(e,filtroProductoIngreso,AddFacturaSelect)" autocomplete="off">
                        </div>
                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody class="tbl-normal">
                                        <tr ng-repeat="listado in filterDatProducIngreso = (listadodetodos_ProductoC | filter : filtroProductoIngreso | orderBy:'-' ) | limitTo:10:10*(pagelistadodeProductos_Ingreso-10)" ng-class="{'ctr': listado.stockMinimo>=listado.Unidad}">
                                            <td>
                                                <div class="col-md-12 btn_sesion">
                                                    <li class="dropdown mega-dropdown btn_li">
                                                        <a href="" class="btn_log btn btn-info btn-sm btn-tabla" class="dropdown-toggle" data-toggle="dropdown" ng-click="verificarStock(listado.id_producto)">Ver <span class="caret"></span></a>
                                    ...
                                    <td>{{listado.codigo_producto}}</td> -->
                                            <td style="width:50px;">
                                                <div class="input-tabla form-group form-group-sm" ng-if="listado.fraccion!=0">
                                                    <input type="number" name="cantidadU" class="form-control input-sm tbl-fc" ng-model="cant.cantidadU" ng-keypress="agregarProductoFacturaADDKey(e,listado.id_producto,cant,AddFacturaSelect)">
                                                </div>
                                            </td>
                                            <td style="width:50px;">
                                                <div class="input-tabla form-group form-group-sm" ng-if="listado.fraccion==0">
                                                ...
                                                <div class="input-tabla form-group form-group-sm" ng-if="listado.fraccion!=0">
                                                    <input type="number" name="cantidadF" class="form-control input-sm tbl-fc" ng-model="cant.cantidadF" ng-keypress="agregarProductoFacturaADDKey(e,listado.id_producto,cant,AddFacturaSelect)">
                                                </div>
                                            </td>
                                            <td>
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="table table-hover table-bordered table-striped">
                                ...
                                <tr ng-repeat="listadoADD in filterDatProducIngresoADD= (listadodetodos_SelectFacturaAdd)">
                                    <td>{{$index + 1}}</td>
                                ...
                                <td>{{listado.codigo_producto}}</td> -->
                                    ...
                                    <td>
                                        ...
                                        <div class="input-tabla form-group form-group-sm" ng-if="listadoADD.fraccion!=0">
                                            <input type="text" name="cantidadF" class="form-control input-sm numero" ng-model="listadoADD.cantidadFraccion" ng-if="listadoADD.fraccion!=0" ng-keypress="EditarProductoFacturaADD(e,listadoADD.id_producto,listadoADD.cantidadUnidad,listadoADD.cantidadFraccion,AddFacturaSelect)">
                                        </div>
                                    </td>
                                    <td>
                                        %{{listadoADD.iva}}
                                    ...
                                    <td>
                                        <div class="input-tabla form-group form-group-sm">
                                            <input type="text" ng-if="listadoADD.fraccion!=0" name="cantidadF" class="form-control input-sm" ng-model="listadoADD.valor_unidad" ng-keypress="EditarProductoFacturaADDValores(e,listadoADD.id_producto,listadoADD.valor,listadoADD.valor_venta,listadoADD.valor_unidad,AddFacturaSelect)">
                                            <input type="text" ng-if="listadoADD.fraccion==0" name="cantidadF" class="form-control input-sm" ng-model="listadoADD.valor_venta" ng-keypress="EditarProductoFacturaADDValores(e,listadoADD.id_producto,listadoADD.valor,listadoADD.valor_venta,listadoADD.valor_unidad,AddFacturaSelect)" disabled="disabled">
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-danger  btn-sm btn-tabla" data-dismiss="modal" ng-click="EliminarProductoFacturaADD(listadoADD.id_producto,AddFacturaSelect)">
                                            <span class="material-icons">delete_forever</span> </button> <br> <button type="button" class="btn btn-warning  btn-sm btn-tabla" data-toggle="modal" data-target="#myModalFechaCaducidad" ng-click="AddProductoFechaCaducidad(listadoADD.id_producto,listadoADD.presentacion,listadoADD.descripcion,listadoADD.cantidadUnidad,listadoADD.cantidadFraccion)">
                                            <span class="material-icons">delete_forever</span> </button>
                                    </td>
                                </tr>
                            </table>
                            <div class="row tarjetas">
                                <!-- Tabla -->
                                <div class="col-md-4">
                                    <table class="table table_totales">
                                        <thead class="tc_totales">
                                            <tr>
                                                <th>Total Iversion</th>
                                                <th>Total Ventas</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>$ {{valorInversion | number:0}}</td>
                                                <td>$ {{valorVentas | number:0}}</td>
                                                <td>$ {{valorGanancia | number:0}}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <!--  <div class="col-md-3">
                                    <div class="card datos-utilidad">
                                        <div class="card-header card-datos">
                                            <h3 class="card-title titulo">  <span class="text">$ {{valorInversion  | number:2}}</span></h3>
                                            <span class="icono"><i class="material-icons">payment</i></span>
                                        </div>
                                        <div class="card-body">
                                            <h4>Total Inversion</h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="card datos-utilidad">
                                        <div class="card-header card-datos">
                                            <h3 class="card-title titulo">  <span class="text">$ {{valorVentas  | number:2}}</span></h3>
                                ...
                                <div class="col-md-3">
                                    <div class="card datos-utilidad">
                                        <div class="card-header card-datos">
                                            <h3 class="card-title titulo">  <span class="text">$ {{valorGanancia  | number:2}}</span></h3>
                                            <span class="icono"><i class="material-icons">dns</i></span>
                                        </div>
                                        <div class="card-body">
                                            <h4>Total Ganancia</h4>
                                        </div>
                                    </div>
                                </div> -->
                            </div>
                                ...
                                <form>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group bmd-form-group">
                                            ...
                                            <input type="text" placeholder="Nombre" class="form-control input-sm" ng-model="insertarFechaCaducidad.referencia" name="nombreCliente">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group bmd-form-group">
                                            <label class="bmd-label-floating">Cantidad</label>
                                            <input type="number" placeholder="Direccion" class="form-control input-sm" ng-model="insertarFechaCaducidad.cantidad" name="direccionCliente">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group bmd-form-group">
                                            <label class="bmd-label-floating">Fecha Caducidad</label>
                                            <input type="date" placeholder="Telefono" class="form-control input-sm" ng-model="insertarFechaCaducidad.fechaCaducidad" name="telefonoCliente">
                                        </div>
                                    </div>
                                </form>
                                <div class="card-footer">
                                    <div class="col-md-12">
                                        <button type="button" class="btn btn-info btn-sm" ng-click="guardarDetalleFechaCaducidad(insertarFechaCaducidad,id_fechacaducidad)">Guardar</button>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="table-responsive ta-p">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <tr ng-repeat="listado in filterDatProducIngreso = (listaDetallefechaCaducidad )">
                                                    <td>{{listado.lote}}</td>
    ...
    <uib-tab index="2">
        ...
        <div class="card">
             ...
             -->
                <div class="row head-buscador">
                    ...
                    <div class="col-md-6 paginacion">
                        <uib-pagination class="pagination-mod" total-items="filterIngresos.length" ng-model="pagelistadodetodos_Ingreso" max-size="5" class="pagination-sm" boundary-links="true" ng-change="paginalistadodetodos_Ingreso()" previous-text="&lsaquo;" next-text="&rsaquo;" items-per-page=40></uib-pagination>
                    </div>
                </div>
            </div>
            <div class="card-body card-b-l">
                <div class="table-responsive">
                    <table datatable="ng" dt-options="vm.dtOptions" class="table table-hover table-striped">
                        <thead>
                            <tr>
                                <th>No.</th>
                                <th>Nombre Producto</th>
            ...
            <div id="modal-vereditarIngresoProducto" class="modal" role="dialog">
                <div class="modal-dialog">
                    <!-- Modal content-->
                    <div class="modal-content">
                        <div class="modal-header">
            ...
            <div id="modal-eliminarIngreso" class="modal " role="dialog">
                <div class="modal-dialog">
                    <!-- Modal content-->
                    <div class="modal-content">
