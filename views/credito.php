...
<form  id="Form_insertarIngresos">
	...
	<div class="col-md-4">
		<div class="card">
			<div class="card-header card-header-rose card-header-icon">
				...
				<h3 class="card-title">No Credito</h3>
			</div>
			<div class="card-body">
				
				<h3 align="center">{{noListCredito}} </h3>
		...
		<div class="card-body">
			<div class="col-md-12">
					<div class="container-3">
						...
						<input type="search" id="search" placeholder="Buscar Producto..."  onclick="ClearSearch()" name="id_producto" id="id_producto" ng-model="filtroProductoIngreso" ng-keypress="listadotodos_ProductoCreditoKeypress(e,filtroProductoIngreso)" ng-change="listadotodos_ProductoChange(filtroProductoIngreso)" >
					</div>
				</div>
			<!-- <div class="col-md-12">
				<div class="container-3">
					...
					<table class="table table-hover">
						<thead>
							<tr class="table-info">
								<th>Cantidad</th>
								<th>Producto</th>
								<th ng-show="false">Barra 1</th>
								<th ng-show="false">Barra 2</th>
								<th ng-show="false">Barra 3</th>
						...
						<tbody class="tbl-normal">
							<tr ng-repeat="listado in filterDatProducIngreso = (listadodetodos_Producto | filter : filtroProductoIngreso) | limitTo:5:5*(pagelistadodeProductos_Ingreso-1)" ng-class="{'ctr': listado.stockMinimo>=listado.Unidad}">
								<td>
									<div  class="col-md-12 btn_sesion">
										<li class="dropdown mega-dropdown btn_li">
											<a href="" class="btn_log btn btn-info btn-sm" class="dropdown-toggle" data-toggle="dropdown" ng-click="verificarStock(listado.id_producto)">Stock  <span class="caret"></span></a>
								...
								<td ng-show="false">{{listado.codigo_barrasUno}}</td>
								<td ng-show="false">{{listado.codigo_barrasDos}}</td>
								<td>
									<div class="col-sm-4">
										<input type="number" name="cantidadU" class=" form-control input-sm"  ng-model="cant.cantidadU" ng-keypress="agregarProductoPlansepareFormPress(e,listado.id_producto,listado.descripcion,listado.codigo_producto,listado.valor_venta,listado.valor_unidad,listado.ivaValor,listado.iva,listado.presentacion,listado.fraccion,cant)">
									</div>
									<div class="col-sm-4">
					...
					<table class="table table-hover">
						...
						<tbody class="btl-normal">
							<tr ng-repeat="listado in filterproducDetalles = (listaProductosPlan_separe)">
								...
								<td class="table-info">${{listado.valorTotal | number:0}}  </td>
								<td>
						...
						<tr>
							...
							<th class="table-success tblCenter"> <h2> <strong> $ {{totalapagarSepare | number:0}} </strong></h2></th>
						</tr>
					</tbody>
	...
	<div class="row">
	<label class=" col-form-label"><strong>Valor Aumeto</strong></label>
	<div class="col-md-3">
	...
	<label class=" col-form-label"><strong>Fecha Final </strong></label>
	<div class="col-md-3">
		<div class="form-group">
		...
		<div class="modal-body">
			<div class="row">
				<div class="col-md-offset-2 col-md-8">
					<input type="text" class="form-control input-sm" placeholder="Buscar..." name="id_producto" id="id_producto" ng-model="filtroProductoIngresoCliente">
				</div>
				<div class="col-md-12">
				...
				<div class="col-md-12">
					<div class="table-responsive">
						<table class="table table-hover">
							...
							<tbody>
								<tr ng-repeat="listado in filterDatProducclientFactura = (listadodetodos_clientesFactu | filter : filtroProductoIngresoCliente) | limitTo:20:20*(pagelistadodetodos_clientesFactu-1)">
...
<!-- --------------------- SEGUNDO TAP  -->
<uib-tab index="1">
<uib-tab-heading ng-click="buscarCreditoList()">
...
<div class="col-md-4">
	<div class="card">
		<div class="card-header card-header-rose card-header-icon">
			...
			<h3 class="card-title">codigo Credito</h3>
		</div>
		<div class="card-body">
	...
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-body">
				...
				<input type="hidden" name="id_cliente" id="id_cliente" ng-model="insertarplansepareB.id_cliente">
				<div class="input-group">
					
					<input type="text" class="form-control input-sm" name="identificacion" placeholder="identificación" id="identificacion" ng-model="insertarplansepareB.identificacion" disabled>
					<!-- <span class="input-group-btn"> -->
					<input type="text" class="form-control input-sm" name="nombre_clientes" placeholder="nombre" id="nombre_clientes" ng-model="insertarplansepareB.nombre_clientes" disabled>
				<button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal_clientes_FacturaVista"><span class="icon-search"></span> Buscar</button>
				</div>
...
<div id="modal_clientes_FacturaVista" class="modal" role="dialog">
<div class="modal-dialog">
	<!-- Modal content-->
	<div class="modal-content">
		<div class="modal-header">
						...
						<table class="table table-hover">
							...
							<tbody>
								<tr ng-repeat="listado in filterDatProducclientFactura = (listadodetodos_clientesFactu | filter : filtroProductoIngreso) | limitTo:20:20*(pagelistadodetodos_clientesFactu-1)">
									...
									<td>{{listado.nombre_cliente}}</td>
									<td>
										<button type="button" class="btn btn-info btn-sm" data-dismiss="modal" ng-click="agregarClienteplansepareBusq(listado.id_cliente,listado.cc_cliente,listado.nombre_cliente,insertarplansepareB)">Agregar</button>
									</td>
								</tr>
							</tbody>
						</table>
...
<div class="col-md-6">
	<h3>$ {{totalDeudaCreditos | number:0 }}</h3>
</div>
</div>
...
<div class="table-responsive">
	<table class="table table-hover">
		...
		<tbody class="tbl-normal">
			...
			<tr ng-repeat="listado in filterRangoFechasPl = (ListaPlanesDados | filter : filtroLiistaPl | filter: filtroLiistaPl2 | orderBy: '-') | limitTo:25:25*(pageListaPlanesDados-1) track by $index">
				...
				<td>${{listado.total_pagosepare | number:0}}</td>
				<td>${{listado.descuento_abonos | number:0}}</td>
						...
						<table class="table table-striped table-hover">
							...
							<tbody>
								<tr ng-repeat="listado in filterlistacuotaPlansepare = (ListaProductosPlanSepare)">
									...
									<td>
										<button type="button" class="btn btn-success"   ng-click="imprimmirRecibocuptaCredito(listado.id_abonos_credito,listado.id_credito)"><i class="material-icons">print</i></button>
									</td>
